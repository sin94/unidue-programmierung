...
public class Miniprojekt1 {
  ...
  public static void main(String args[]) {
    ...
    System.out.println("Aufruf von funktion1 mit x=2 liefert den Wert: "
      + m1.funktion1(2));
    System.out.println("Aufruf von funktion2 mit x=6 liefert den Wert: "
      + m1.funktion2(6));
    System.out
      .println("Aufruf von funktion3 mit x=49 und y= 27 liefert den Wert: "
        + m1.funktion3(49, 27));
    System.out
      .println("Aufruf von funktion4 mit x=27, y=10 und z=10 liefert den Wert:"
        + m1.funktion4(27, 10, 10));
    System.out.println("Aufruf von garpf1 mit x= -1 liefert den Wert:"
      + m1.graph1(-1));
    System.out.println("Aufruf von graph2 mit x=3 liefert den Wert:"
      + m1.graph2(3));
  }
