  ...
  public boolean enthalten(Speise_A2 speise2) {      //mit Zutaten von speise2 kann 'THIS' gekocht werden
    ...
    while (zeiger1 != null) {                  //geht alle Zutaten der 1. Speise durch
      ...
      while (zeiger2 != null) {               //geht alle Zutaten der 2. Speise durch
        if (zeiger2.lebensmittel == zeiger1.lebensmittel && zeiger2.menge >= zeiger1.menge)   //Zutat in hinreichender Menge gefunden...
        {
          break;                     //innere Schleife kann abgebrochen werden
        }
        zeiger2 = zeiger2.nachfolger;         //Zutat (evtl. in nicht ausreichnder Menge) nicht gefunden -> n�chste Zuatat von Sp.2
      }   //end of inner while
      if (zeiger2 == null) {
