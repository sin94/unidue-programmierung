...
public class Konstante {
  ...
  public static final String[] AERZTE = new String[]{"Dr. Scheel Viktor", "Dr. Luther Christoph", "Dr.Schreiner Kevin", "Dr. "
    + "Goldbach Sabina", "Dr. Schuman Alexandra", "" +
  ...
  public static final Station[] STATIONEN = new Station[]{new Station(1, "Innere Medizin", 10, 4),
  ...
  public static final Diagnose DIAGNOSEN[] = new Diagnose[]{new Diagnose("S63.0", AERZTE[1], 0, 0),
  ...
  public static final Medikament[] MEDIKAMENTE = new Medikament[]{new Medikament("Katadolon", "Flupirtin", "Tabletten", 5.00f),
