...
public class Krankenhaus {
  ...
  */
  public double stationsauslastung(Station s) {   //Auslastung = (BELEGTE BETTEN-KAPAZIT�T)
    return ((double) ((s.kapazitaetG + s.kapazitaetP) - (s.freiG + s.freiP)) / (s.kapazitaetG + s.kapazitaetP)) * 100;
  }//end proc
  ...
  */
  public String laengste_Aufenthalt() {
    ...
    return (max == null) ? null : max.name + ' ' + max.vorname; //Keine Person gefunden dann null ansonsten Name + vorname
  }//end proc
