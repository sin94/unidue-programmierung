...
//Liste der Aerzte im Krankenhaus
    String[] aerzte = {"Dr. Scheel Viktor", "Dr. Luther Christoph", "Dr.Schreiner Kevin", "Dr. Goldbach Sabina", "Dr. Schuman Alexandra", "" +
      "Dr. David Jacob", "Dr. Hutton", "Dr. Schaueble Manfred", "Dr. Bohlen Alex", "" +
      "Dr.Schummacher Katharina", "Dr. Wagner Christian", "Dr.Lehman steven", "Dr. Laila Mansour", "Dr. Kamilion antonova", "" +
      "Dr. Octavia irene", "Dr. Thomson Emanuel", "Dr. Ernst Michael", "Dr. Severin David", "Dr. Maximilian Christian", "" +
      "Dr. Weber Michael", "Dr. Anton axel", "Dr. Dorloff Hamid", "Dr. Goldbach Daniel", "Dr. Petrow Erik", "" +
      "Dr. Bethofen Uwe", "Dr. Alfred Servantes", "Dr. Santos Armin", "Dr. Thomas Ingo", "Dr. Perez Alexanda"};
//Liste der Stationen im Krankenhaus
    Station[] s = {new Station(1, "Innere Medizin", 10, 4),
...
//( String diagS, String diagA, int laborU, int operations)
    Diagnose[] diag = {new Diagnose("S63.0", aerzte[1], 0, 0),
...
//Liste der Medikamente, die die Patienten bekommen haben aufgrund der Diagnosen
    Medikament[] medi = {new Medikament("Katadolon", "Flupirtin", 1, 5.00f),
...
//Patient 8 wird in s7 stationaer behandelt
    ...
    santamaria.ausgabe();
    System.out.println("");
    System.out.println("Auslastung s: " + santamaria.stationsauslastung(santamaria.stationen[1]) + "%");
    System.out.println("Patient " + santamaria.laengste_Aufenthalt() + " hat die laengste Aufenthalt");
