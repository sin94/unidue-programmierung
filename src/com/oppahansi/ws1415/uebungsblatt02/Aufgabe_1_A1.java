...
public class Aufgabe_1_A1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Bitte geben Sie den Buchstaben ein, dessen Position im Alphabet Sie wissen möchsten.");
    ...
    if (65 <= x && x <= 90) {
      ...
      x = x - 32;                     //da der Zahlenwert von "A" um 32 höher ist als der von "a" wird x hier um 32 verkleinert
      System.out.println("" + Eingabe + " ist der " + (x - 64) + ". Buchstabe im Alphabet.");
    }
    else {
