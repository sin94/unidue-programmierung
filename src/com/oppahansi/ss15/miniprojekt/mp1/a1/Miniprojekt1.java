...
public class Miniprojekt1 {
  ...
  public static void main(String[] s) {
    ...
    System.out.println("R(5|4) liegt innerhalb der Flaeche: "
      + m1.enthaeltPunkt(5, 4));
    System.out.println("Erwarteter Wert: \t\t\t\t\t\t\t\t\t\tfalse \n");

    System.out.println("S(-5|12) liegt innerhalb der Flaeche: "
      + m1.enthaeltPunkt(-5, 12));
    System.out.println("Erwarteter Wert: \t\t\t\t\t\t\t\t\t\t\tfalse \n");
    ...
    System.out.println("Aufruf von funktion2 mit x = 4 liefert den Wert: "
      + m1.funktion2(4));
