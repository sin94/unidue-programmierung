...
public class Flaechenberechnung {
  ...
  /**
   * Diese Methode soll die Flaeche berechenen, die das gegebene Rechteck belegt.
  ...
  /**
   * Diese Methode soll auch die Flaeche berechenen, die das gegebene Rechteck belegt.
