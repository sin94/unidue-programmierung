...
public class Taschenrechner {
   ...
   * rechne(3, 5, "+") --> 8
   * rechne(10,5, "-") --> 5
   * Als a und b werden dabei beliebige int Werte uebergeben, zeichen ist eins der folgenden Zeichen:
   * +,-,*,/
  ...
  public static int rechne(int a, int b, String zeichen) {
    if (zeichen == "+") { // Strings mit == zu vergleichen ist schlecht und sollte später nicht mehr benutzt werden.
