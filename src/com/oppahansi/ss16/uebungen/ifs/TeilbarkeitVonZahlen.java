...
public class TeilbarkeitVonZahlen {
  ...
  /**
   * Diese Methode soll zurueckgeben, ob die Zahl zahl ganzzahlig durch zahl2 teilbar ist.
   * Eine Zahl ist genau dann ganzzahlig durch eine andere Zahl teilbar, wenn zahl%zahl2==0 ist.
   * Also muss diese Methode ueberpruefen, ob zahl%zahl2 == 0. Falls dieser Ausdruck wahr ist, soll
