...
public class SchereSteinPapier {
  ...
  /**
   * Diese Methode soll zur�ckgeben, welches Symbol nach den Schere Stein Papier Regeln
   * gegen das �bergebene Symbol gewinnen w�rde.
   * Schere schl�gt Papier, Papier schl�gt Stein, Stein schl�gt Schere.
   * Entsprechend soll die Methode beim Aufruf
   * gewinner("Papier")--> "Schere"
   * gewinner("Stein") --> "Papier"
   * gewinner("Schere")--> "Stein"
   * zur�ckgeben
   */
