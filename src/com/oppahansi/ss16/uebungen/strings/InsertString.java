...
public class InsertString {
  ...
  /**
   * Der String toInsert soll in den String string an die Stelle wo eingef�gt werden.
   * Dabei bezeichnet wo das Zeichen, an dem der String toInsert beginnt.
   * Nach toInsert folgen dann die Zeichen, die vorher in string ab dieser Stelle standen.
   * Beispiel: insert("Halt!", "llo We", 2) --> "Hallo Welt!"
   */
