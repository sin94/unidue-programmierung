...
public class AnagrammTester {
  ...
  /**
   * Diese Methode soll zurueckgeben, ob die beiden Strings s1 und s2 Anagramme sind.
   * Zwei Woerter sind genau dann Anagramme, wenn man ein Wort durch Vertauschen der Buchstaben
   * aus dem anderen Wort erzeugen kann. Dazu muessen beide Worter die gleichen Buchstaben in der
   * gleichen Anzahl enthalten. Auf Gross und Kleinschreibung wird dabei nicht geachtet.
   * Mit String.toLowerCase(String) kann man sich einen String zurueckgeben lassen, der
   * die gleichen Zeichen wie der uebergebene String enthaelt, aber nur in Kleinschreibung.
   * Beispiele fuer Anagramme sind:
   * mehl und helm
   * ampel und lampe
   * naja milchsocke und michael jackson
   */
