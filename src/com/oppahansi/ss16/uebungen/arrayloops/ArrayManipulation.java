...
public class ArrayManipulation {
   ...
   * Es soll nichts zurueckgegeben werden, das uebergeben Array muss stattdessen veraendert werden.
   ...
   * Das heisst, das letzte Element steht nach dem Aufruf an letzter Stelle, ...
