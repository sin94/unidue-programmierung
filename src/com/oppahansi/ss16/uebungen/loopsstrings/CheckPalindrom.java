...
public class CheckPalindrom {
  ...
  /**
   * Diese Methode soll den als Parameter uebergebenen String umdrehen.
   * Der erste Buchstabe steht dann an letzter Stelle, der zweite davor und so weiter.
   * Der letzte Buchstabe steht dann am Anfang.
   * Beispiel: reverse("abc")-->"cba"
   * reverse("deeff")-->"ffeed"
   * Tipp: mit der Methode String.charAt(int index)
   * kann man den Buchstaben an der Stelle index herausfinden
   * Tipp 2: Man kann mit der Methode String.toCharArray() einen String in ein char Array umwandeln.
   */
   ...
   * Ein Wort ist genau dann ein Palindrom, wenn gilt, dass das Wort in beide Richtungen gelesen identisch ist.
   * Beispiele daf�r: Lagerregal, Reliefpfeiler, Rentner
   * Gross- und Kleinschreibung wird dabei nicht beachtet.
   * Die Methode soll also beim Aufruf zurueckgeben:
   * palindrom("Lagerregal") --> true
   * palindrom("Rentner")    --> true
   * palindrom("Hallo Welt!")--> false
   */
