...
public class ZahlenZaehlen {
  ...
  /**
   * Diese Methode soll zaehlen, wie viele Zahlen der String string enthaelt.
   * Dabei ist string ein Satz, der verschiedene Woerter und eben auch Zahlen enthaelt.
   * Eine Zahl ist hierbei ein Teilstring, der vollstaendig aus Ziffern besteht und von
   * Leerzeichen umgeben ist oder der Beginn oder das Ende von string ist.
   */
  ...
  /**
   * Diese Methode soll den Durchschnitt aus allen Zahlen im String string zurueckgeben.
   * Enthaelt string keine Zahlen, soll 0 zurueckgegeben werden.
   */
