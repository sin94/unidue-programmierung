...
public class GameOfLife {
    ...
    public int countNeighbours(int posX, int posY) {
        ...
        int counter = 0;
        if (board[translateX(posX - 1)][translateY(posY)] == 1) counter++;
        if (board[translateX(posX - 1)][translateY(posY - 1)] == 1) counter++;
        if (board[translateX(posX)][translateY(posY - 1)] == 1) counter++;
        if (board[translateX(posX + 1)][translateY(posY - 1)] == 1) counter++;
        if (board[translateX(posX + 1)][translateY(posY)] == 1) counter++;
        if (board[translateX(posX + 1)][translateY(posY + 1)] == 1) counter++;
        if (board[translateX(posX)][translateY(posY + 1)] == 1) counter++;
