...
public class Snowboardweitsprung{ 
		public static void main(String[] unbenutzt){
			...
			int[] s1 = {13, 15, 11}; s[1] = new Amateur("Lisa", s1);
			int[] s2 = {26, 34, 21, 19}; s[2] = new Profi ("Vera", s2);
			int[] s3 = {33, 12, 24, 27}; s[3] = new Profi ("Erik", s3);
			int[] s4 = {14, 8, 12}; s[4] = new Amateur("Jens", s4); // ***
			int gA = 0, SiegerA = 0; int hoechPunktA = 0;
			int gP = 0, SiegerP = 0; int hoechPunktP = 0;
