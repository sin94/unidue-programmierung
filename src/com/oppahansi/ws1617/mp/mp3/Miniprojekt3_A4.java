 ...
 *
 * Solved/Edited by Tornike K. Possible solution - there are other ways to
 * solve these tasks.
 */
...
public class Miniprojekt3_A4 {
	...
	public static void main(String[] args) {
		...
		RElement r1 = new RElement(new Piste[]{pZinsbergAbfahrt},
				new Lift[]{ lZinsbergLift}, new boolean[]{false});
