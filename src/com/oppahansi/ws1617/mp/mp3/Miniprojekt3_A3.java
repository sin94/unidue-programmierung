 ...
 *
 * Solved/Edited by Volkan T. Possible solution - there are other ways to
 * solve these tasks.
 */
...
public class Miniprojekt3_A3 {
        ...
        for (int x = 0; x < skigebiet.length; x++){
            ...
            if (skigebiet[x].lifte != null){
                for (int i = 0; i < skigebiet[x].lifte.length; i++){
                    System.out.println(" " + skigebiet[x].lifte[i].name + " --> " + skigebiet[x].lifte[i].ziel.name + "   ");
                }
            }
            if (skigebiet[x].pisten != null){
                for (int i = 0; i < skigebiet[x].pisten.length; i++){
                    System.out.println(" " + skigebiet[x].pisten[i].name + " --> " + skigebiet[x].pisten[i].ziel.name + "   ");
                }
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        RElement fahrer1 = new RElement(new Piste[]{pBuckelpiste, pZinsbergAbfahrt, pQuerverbindung},
                new Lift[]{lOberbergLift},
                new boolean[]{false, true, true, true});

        RElement fahrer2 = new RElement(new Piste[]{pSeidlalmAbfahrt, pTalabfahrtLeicht},
                new Lift[]{},
                new boolean[]{true, true});

        RElement fahrer3 = new RElement(new Piste[]{pSeidlalmAbfahrt, pTalabfahrtLeicht, pQuerverbindung, pBuckelpiste, pZinsbergAbfahrt},
