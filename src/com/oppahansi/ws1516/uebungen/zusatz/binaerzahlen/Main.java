...
public class Main {
   ...
   public static void main(String[] args) {
      ...
      System.out.println("1100100 as decimal number is:  " + test1.toInt("1100100") + "  (100 expected)");
      ...
      System.out.println("101000 bitwise OR 11001 is:  " + test1.bitwiseOr(test3.toString(), test4.toString()) + "  (111001 expected)");


      String binary1 = "100101";
      String binary2 = "110001";

      System.out.println("100101 bitwise AND 110001 is:  " + test1.bitwiseAnd(binary1, binary2) + "  (100001 expected)");

      System.out.println("\n100101 bitwise ADD 110001 is:  " + test1.bitwiseAdd(binary1, binary2) + "  (1010110 expected)");
   }
